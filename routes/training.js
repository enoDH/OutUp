...
router.patch('/plan', passport.authenticate('jwt', { session: false }), controller.updatePlan);
router.patch('/description', passport.authenticate('jwt', { session: false }), upload.single('image'), controller.updateDescription);
